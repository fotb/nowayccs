...
@Entity
@Table(name = "ENT_SRV_COUNT_TODAY_VIEW")
public class EntSrvCountTodayVO implements Serializable {

	private static final long serialVersionUID = 4982026247133223561L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EntSrvCountTodayVO other = (EntSrvCountTodayVO) obj;
		if (entpriseId == null) {

...
public class Constants {
    ...
    static {
        DICT_DICTTYPE_HASHMAP.put(String.valueOf(
                DICT_DICTTYPE_LLFS), "业务联络方式");
        DICT_DICTTYPE_HASHMAP.put(String.valueOf(
                DICT_DICTTYPE_MYD), "满意度");
        DICT_DICTTYPE_HASHMAP.put(String.valueOf(
                DICT_DICTTYPE_QZFS), "求助方式");
        DICT_DICTTYPE_HASHMAP.put(String.valueOf(
                DICT_DICTTYPE_QZQY), "求助区域");
        DICT_DICTTYPE_HASHMAP.put(String.valueOf(
                DICT_DICTTYPE_ZXLX), "业务咨询类型");
        DICT_DICTTYPE_HASHMAP.put(String.valueOf(
                DICT_DICTTYPE_SLRQ), "受理人群");
        DICT_DICTTYPE_HASHMAP.put(String.valueOf(
                DICT_DICTTYPE_COMMONLB), "信息类别");

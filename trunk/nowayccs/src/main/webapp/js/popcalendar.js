...
//	email :	fuushikaden@yahoo.com
	...
	var imgDir = "images/img/"					// directory for images ... e.g. var imgDir="/img/"
    ...
    */
	...
	if (dom)
	{
		...
		if (showToday==1)
		{
			document.write ("<tr bgcolor=#f0f0f0><td style='padding:1px' align=center  valign=middle><span style='float:left;'><iframe name=stime id=stime src='timeS.htm' frameborder=0 width=90 height=20 scrolling=no allowtransparency=true></iframe></span> <span id='lblToday'></span></td></tr>")
		}

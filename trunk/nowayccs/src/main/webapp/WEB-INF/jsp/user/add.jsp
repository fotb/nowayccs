      ...
      <td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr class="table_t1">
            ...
            <td>
            <!-- 
              <logic:notEmpty name="hjRoleList">
                <logic:iterate name="hjRoleList" id="hjRole" indexId="indexID">
                  <html:multibox property="roleID">
                    <bean:write name="hjRole" property="roleId"/>
                  </html:multibox>
                  <bean:write name="hjRole" property="roleName"/>
                  <br>
                </logic:iterate>
              </logic:notEmpty>
               -->

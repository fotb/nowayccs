...
<script type="text/javascript" src="cssandjs/function.js"></script>
    ...
    <tr>
      <td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr class="table_t1">
            <td>姓名：</td>
            <td><html:text property="volunteerName" styleClass="form" size="70"/></td>
          </tr>
		  <tr class="line">
            <td height="1" colspan="2"></td>
          </tr>
          ...
          <tr class="table_t1">
            <td>服务项目：</td>
            <td><html:text property="sevriceName" styleClass="form" size="70"/></td>
          </tr>
		  <tr class="line">
            <td height="1" colspan="2"></td>
          </tr>
          <tr class="table_t1">
            <td>服务时间：</td>
            <td><html:text property="serviceTime" styleClass="form" size="70"/></td>
          </tr>
          <tr class="line">
            <td height="1" colspan="2"></td>
          </tr>
          <tr class="table_t1">
            <td>联系电话：</td>
            <td><html:text property="linkTel" styleClass="form" size="70"/></td>
          </tr>
          <tr class="line">
            <td height="1" colspan="2"></td>
          </tr>
          <tr class="table_t1">
            <td>联系手机：</td>
            <td><html:text property="linkMobile" styleClass="form" size="70"/></td>
          </tr>
          <tr class="line">
            <td height="1" colspan="2"></td>
          </tr>
          <tr class="table_t1">
            <td>邮件地址：</td>
            <td><html:text property="email" styleClass="form" size="70"/></td>
          </tr>
		  <tr class="line">
            <td height="1" colspan="2"></td>
          </tr>
          <tr class="table_t1">
            <td>其他：</td>
            <td><html:textarea property="remark" styleClass="form" cols="130" rows="5"/></td>
          </tr>
          <tr class="line">
            <td height="1" colspan="2"></td>
          </tr>

...
function DefineMonthView(theTextObject){ //the month view construct function
  ...
  this.MinYear = 2000; //year list min value
  ...
  this.Width = 180; //the month view main body's width宽
  this.Height = 150; //the month view main body's height高
  ...
  this.YearListStyle = "font-size:11px; font-family:Verdana;"; //the year list's style年的大小
  this.MonthListStyle = "font-size:11px; font-family:Verdana;"; //the month list's style月大小
  ...
  this.MonthName[11] = "十二月";     //星期颜色，大小
  this.TitleStyle = "cursor:default; color:#000000; background-color:" + this.UnselectBgColor + "; font-size:11px; font-weight:bolder; font-family:Times new roman; text-align:center; vertical-align:bottom;"; //the month view title area's style
  ...
  this.WeekName[4] = "四";
  this.WeekName[5] = "五";
  this.WeekName[6] = "六";       //现在时间颜色，大小
  this.FooterStyle = "cursor:hand; color:#ff0000; background-color:" + this.UnselectBgColor + "; font-size:11px; font-family:Verdana; text-align:left; vertical-align:middle;"; //the month footer area's style
  this.TodayTitle = "Today:"; //today tip string, font is include this.FooterStyle
  this.MonthBtStyle = "font-family:Marlett; font-size:9px;"; //the change month button style月按钮大小
  ...
  //font is include this.MonthBtStyle  
  this.MonthGridStyle = "border-width:1px; border-style:solid; border-color:#000000;"; //边框颜色the month view main body's default style
  this.HeaderStyle = "height:25px; background-color:#6DBA8E;"; //头条颜色大小the month view header area's style
  ...
  this.LineStyle = "width:90%; height:1px; background-color:#000000;"; //线条the month view title area and day area compart area front style
  this.DayStyle = "cursor:hand; font-size:10px; font-family:Verdana; text-align:center; vertical-align:middle;"; //数字the month view day area's style
...
this.CreateMonthGrid = function(theYear, theMonth, theDay){ //refresh the month view to the date, main action is run this.setDayList() and set this.Source.value
  ...
  this.InitialMonthView = function( ){
    ...
    theDivObject.style.posLeft = this.GetoffsetLeft(this.Source)-0;
    theDivObject.style.posTop = this.GetoffsetTop(this.Source) + this.Source.offsetHeight-0;

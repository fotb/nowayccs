...
public class Constants {
	...
	public static final HashMap<String, String> SYS_SEX_HASHMAP = new HashMap<String, String>();
	...
	public static final HashMap<String, String> SYS_VOLUNTEER_STATUS_HASHMAP = new HashMap<String, String>();

	static {
		SYS_VOLUNTEER_STATUS_HASHMAP.put(String.valueOf(SYS_VOLUNTEER_STATUS_YES), "服务中");
		SYS_VOLUNTEER_STATUS_HASHMAP.put(String.valueOf(SYS_VOLUNTEER_STATUS_NO), "停止服务");
	}

	/* 员工状态:0:离职 1在职 */
	public static final String SYS_USER_STATUS_NO = "Y";
	public static final String SYS_USER_STATUS_YES = "1";
	public static final HashMap<String, String> SYS_USER_STATUS_HASHMAP = new HashMap<String, String>();
	...
	static {
		SYS_INFOMATION_STATES_HASHMAP.put(String.valueOf(SYS_INFOMATION_STATES_DB), "待办");
		SYS_INFOMATION_STATES_HASHMAP.put(String.valueOf(SYS_INFOMATION_STATES_CLZ), "处理中");
		SYS_INFOMATION_STATES_HASHMAP.put(String.valueOf(SYS_INFOMATION_STATES_YJA), "已结案");
		SYS_INFOMATION_STATES_HASHMAP.put(String.valueOf(SYS_INFOMATION_STATES_YQX), "已取消");
	}
	...
	public static final Map<String, String> LIFEINFOMATION_RECEIVETYPE_HASHMAP = new HashMap<String, String>();

	static {
		LIFEINFOMATION_RECEIVETYPE_HASHMAP.put(String.valueOf(LIFEINFOMATION_RECEIVETYPE_ZYZ), "一技之长服务者");
		LIFEINFOMATION_RECEIVETYPE_HASHMAP.put(String.valueOf(LIFEINFOMATION_RECEIVETYPE_QY), "服务企业");
	}
	...
	public static final Map<String, String> DICT_DICTTYPE_HASHMAP = new HashMap<String, String>();
	...
	/* 求助类型 */
	/*
	 * public static final int HELP_TYPE_QUERY = 1; //咨询服务类 public static final
	 * int HELP_TYPE_LIFE = 2; //生活服务类 public static final int
	 * HELP_TYPE_TRANSACTION = 3; //事务服务类 public static HashMap
	 * HELP_TYPE_HASHMAP = new HashMap(); static {

...
@Table(name = "VOLUNTEER_SRV_COUNT_TODAY_VIEW")
public class VolunteerSrvCountTodayVO implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VolunteerSrvCountTodayVO other = (VolunteerSrvCountTodayVO) obj;
		if (volunteerId == null) {

...
public class ElevHelpInfoVO extends BaseEntity implements Serializable {
	...
	public String getTrapppedPerson() {
		return trapppedPerson;
	}
	public void setTrapppedPerson(String trapppedPerson) {
		this.trapppedPerson = trapppedPerson;
	}

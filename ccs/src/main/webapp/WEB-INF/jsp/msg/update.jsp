...
function btnnext_save(){
  ...
  //form.action = "msg.do?action=editsave";
  form.submit();
}
function btnback_click() {
  //this.location = "/opr_message_list.do";
   history.back();
}

</script>
<body>
<form:form method="post" action="msg.do?action=editsave" commandName="messageVO">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1">
         ...
         <tr class="line">
          ...
          <tr align="center" class="table_t1">
            <td colspan="4">
              <img src="images/button_save.gif" width="60" height="18" onclick="btnnext_save()" style="cursor: pointer;"/>

      ...
      <td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr class="table_t1">
            <td>所在街道和社区：</td>
            <td width="85%">
	        	<form:select path="areaId" cssClass="form" disabled="true">
	        		
	        	</form:select>
	        	<form:select path="areaSubId" cssClass="form" disabled="true">
          ...
          <tr class="table_t1">
            <td>编号：</td>
            <td>
              <form:input path="volunteerNo" cssClass="form" size="20" disabled="true"/><font color="red">*</font>
            </td>
          </tr>
          <tr class="table_t1">
          <td>是否可以派单：</td>
          <td>
			<form:select path="serviceType" cssClass="form"  disabled="true">
          ...
          <tr class="table_t1">
            <td>姓名：</td>
            <td>
              <form:input path="volunteerName" cssClass="form" size="70" disabled="true"/><font color="red">*</font>
            </td>
          </tr>
          <tr class="line">
            <td height="1" colspan="2">            </td>
          ...
          <tr class="table_t1">
            <td>性别：</td>
            <td>
              <form:select path="sex" cssClass="form" disabled="true">
          ...
          <tr class="table_t1">
            <td>服务项目：</td>
            <td>
              <form:input path="serviceName" cssClass="form" size="70" disabled="true"/><font color="red">*</font>
            </td>
          </tr>
          <tr class="line">
            <td height="1" colspan="2">            </td>
          ...
          <tr class="table_t1">
            <td>服务时间：</td>
            <td>
              <form:input path="serviceTime" cssClass="form" size="70" disabled="true"/><font color="red">*</font>
            </td>
          </tr>
          <tr class="line">
            <td height="1" colspan="2">            </td>
          ...
          <tr class="table_t1">
            <td>联系电话：</td>
            <td>
              <form:input path="linkTel" cssClass="form" size="70" disabled="true"/><font color="red">*</font>
            </td>
          </tr>
          <tr class="line">
            <td height="1" colspan="2">            </td>
          ...
          <tr class="table_t1">
            <td>联系手机：</td>
            <td>
              <form:input path="linkMobile" cssClass="form" size="70" disabled="true"/>
            </td>
          </tr>
          <tr class="line">
            <td height="1" colspan="2">            </td>
          ...
          <tr class="table_t1">
            <td>邮件地址：</td>
            <td>
              <form:input path="email" cssClass="form" size="70" disabled="true"/>
            </td>
          </tr>
          <tr class="line">
            <td height="1" colspan="2">            </td>
          ...
          <tr class="table_t1">
            <td>其他：</td>
            <td>
              <form:textarea path="remark" cssClass="form" cols="130" rows="5" disabled="true"/>
            </td>
          </tr>
          <tr class="line">
            <td height="1" colspan="2">            </td>
